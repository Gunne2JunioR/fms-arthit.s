          ...
          <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
            ...
            {user ? (
              ...
              <Button
                asChild
                size="sm"
                className="inline-flex h-8 sm:h-9 px-4 rounded-full bg-[var(--brand)] hover:bg-[var(--brand-deep)] text-[var(--on-brand)] text-xs font-semibold shadow-md shadow-[var(--brand)]/20 transition-transform hover:scale-105"
              >
