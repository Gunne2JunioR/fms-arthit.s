...
export const MESSAGES: Dictionary = {
  ...
  "department.shortNameTh": { th: "ชื่อย่อ (ไทย)", en: "Abbreviation (Thai)", cn: "学系简称（泰文）" },
  "department.shortNameEn": { th: "ชื่อย่อ (อังกฤษ)", en: "Abbreviation (English)", cn: "学系简称（英文）" },
  "department.faculty": { th: "คณะที่สังกัด", en: "Faculty", cn: "所属学院" },
  "department.selectFaculty": { th: "เลือกคณะที่สังกัด", en: "Select Faculty", cn: "选择所属学院" },
  "department.filterFaculty": { th: "ทุกคณะ", en: "All Faculties", cn: "所有学院" },
  "department.filterStatus": { th: "ทุกสถานะ", en: "All Statuses", cn: "所有状态" },
  "department.head": { th: "หัวหน้าภาควิชา", en: "Head of Department", cn: "系主任" },
  "department.selectHead": { th: "เลือกหัวหน้าภาควิชา", en: "Select Head of Department", cn: "选择系主任" },
  "department.email": { th: "อีเมลติดต่อ", en: "Contact Email", cn: "联系邮箱" },
  "department.phone": { th: "เบอร์โทรศัพท์", en: "Phone Number", cn: "联系电话" },
  "department.officeLocation": { th: "สถานที่ตั้ง/ห้องทำงาน", en: "Office Location", cn: "办公地点/房间" },
  "department.status": { th: "สถานะ", en: "Status", cn: "状态" },
  "department.sortOrder": { th: "ลำดับการแสดงผล", en: "Sort Order", cn: "排序序号" },
  ...
  "department.archiveSuccess": { th: "จัดเก็บภาควิชาเข้าสู่สถานะเก็บถาวรเรียบร้อยแล้ว (เนื่องจากมีข้อมูลอ้างอิง)", en: "Archived successfully due to existing references", cn: "已成功转为归档（由于存在关联数据）" },
  "department.deleteConfirm": { th: "คุณต้องการลบข้อมูลภาควิชานี้ใช่หรือไม่? หากมีข้อมูลอ้างอิงจะถูกเปลี่ยนเป็นสถานะ 'เก็บถาวร'", en: "Are you sure you want to delete this department? If referenced elsewhere, it will be archived safely.", cn: "确定要删除此学系吗？若有系统关联将被安全归档。" },
