...
try {
  ...
  console.warn("⚠️  ไม่สามารถเชื่อมต่อฐานข้อมูลเพื่อ Migrate ได้ กรุณาตรวจสอบว่า Postgres รันอยู่และสร้างฐานข้อมูลแล้ว:", (error as Error).message);
...
try {
  ...
  console.warn("⚠️  ข้ามขั้นตอน Seed ข้อมูล (สามารถรัน npm run db:seed เองภายหลังเมื่อเตรียม DB เสร็จ):", (error as Error).message, "\n");
}
